...
export function createAdminClient({ fetchImpl = globalThis.fetch } = {}) {
  ...
  return {
    ...
    trendingCommentary: () => request('/youtube-trending'),
    saveTrendingCommentary: (body) => request('/youtube-trending', { method: 'POST', body }),
    refreshTrendingCommentary: () => request('/youtube-trending/refresh', { method: 'POST' }),
