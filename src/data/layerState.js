...
export const LAYER_STATE_REGISTRY = Object.freeze([
  ...
  Object.freeze({ id: 'aqicn', token: '2', disposition: 'enabled-only' }),
  Object.freeze({ id: 'aviationapi', token: '6', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'idigbio', token: '1', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'luchtmeetnet', token: '3', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'natural-hazards', token: '9', disposition: 'enabled-only' }),
  Object.freeze({ id: 'nps-parks', token: '7', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'pm25-opendata', token: '4', disposition: 'enabled-only' }),
  Object.freeze({ id: 'purpleair', token: '0', disposition: 'enabled-only' }),
  Object.freeze({ id: 'radio', token: 'r', disposition: 'enabled+options', optionOwner: 'radio' }),
  Object.freeze({ id: 'refuge-restrooms', token: '5', disposition: 'enabled-only' }),
  Object.freeze({ id: 'ridb', token: '8', disposition: 'enabled-only' }),
